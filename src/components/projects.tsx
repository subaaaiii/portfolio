  ...
  return (
    ...
    >
      ...
      <div className="grid grid-cols-3 gap-8 mt-4 mx-4 md:mx-0">
        ...
        >
          <div className="absolute top-3 left-3 bg-secondary py-2 px-3 rounded-full text-white text-sm">
            Featured
          </div>
          ...
          <div className="flex flex-col p-3">
            ...
            <div className="flex flex-wrap mt-2 gap-2">
              <div className="px-3 py-2 rounded-full bg-secondary/20 text-sm text-secondary">
                React.JS
              </div>
              <div className="px-3 py-2 rounded-full bg-secondary/20 text-sm text-secondary">
                Tailwindcss
        ...
        {/* stock predict */}
        <div className="relative pb-12 col-span-3 md:col-span-1 shadow-lg rounded-lg overflow-hidden hover:-translate-y-2 transition-transform duration-300 cursor-pointer">
          <div className="relative  w-full h-60  bg-secondary/20 overflow-hidden">
            <img
              loading="lazy"
              src={stock}
